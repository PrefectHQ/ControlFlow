...
There are a few ways to [create tasks](/concepts/tasks/creating-tasks), but all of them permit a great deal of configuration. This document covers the various options available.
...
For more information, see [Result Types](/concepts/tasks/result-types).
...
For more information, see [Result Validators](/concepts/tasks/result-types#result-validators).
