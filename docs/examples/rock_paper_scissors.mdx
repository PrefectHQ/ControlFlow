...
def check_play_again(user_choice, ai_choice) -> bool:
    """
    Tell the user if they won, then find out if they want to play again.
    """
...
def rock_paper_scissors():
    ...
    while keep_playing:
        ...
        keep_playing = check_play_again(user_choice, ai_choice)
